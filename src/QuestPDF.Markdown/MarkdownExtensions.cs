...
public static class MarkdownExtensions
{
    ...
    internal static IContainer PaddedDebugArea(
        this IContainer container,
        string label,
        string color
    ) => container.DebugArea(label, color).PaddingTop(20);

    internal static TextSpanDescriptor ApplyStyles(
        this TextSpanDescriptor span,
        IList<Func<TextSpanDescriptor, TextSpanDescriptor>> applyStyles
    )
    {
